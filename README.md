...
## Install
    ...
    pm2 install pm2-logrotate-legacy-am
...
`pm2 set pm2-logrotate-legacy-am:<param> <value>`

e.g:
- `pm2 set pm2-logrotate-legacy-am:max_size 1K` (1KB)
- `pm2 set pm2-logrotate-legacy-am:compress true` (compress logs when rotated)
- `pm2 set pm2-logrotate-legacy-am:rotateInterval '*/1 * * * *'` (force rotate every minute)
